...
public class Rational implements IRational {
	...
	public Rational construct(int numerator, int denominator) throws IllegalArgumentException {
		...
		return new Rational(numerator,denominator); //Create new Rational object by calling Constructor() method
	}
	...
	public boolean equals(Object obj) {
		...
		if(this.getClass() != obj.getClass()) // cannot check two different objects for equality of Rational number 
			return false;
		Rational r1 = (Rational)obj; // Type cast obj to Rational before comparing
