...
public class FizzBuzz {
    ...
    public static String[] messages(int start, int end) throws IllegalArgumentException {
        ...
        String[] strArr= new String[end-start]; //String array for messages
        ...
        String divArr[] = new String[j]; //String array for Divisibility messages to return
        for(int index =0; index<j;index++)
        {
            divArr[index] = strArr[index];
